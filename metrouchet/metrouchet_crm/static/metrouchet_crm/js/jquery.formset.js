...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        uiText: {
            addPrompt: '<i class="fa-solid fa-circle-plus fa-xl" style="color: #12ba2e;"></i>',         // Text used on the 'add a new form' control.
            removePrompt: '<i class="fa-solid fa-circle-minus fa-xl" style="color: #d51a1a;"></i>',        // Text used on the 'delete this existing form' control.
        },
    };
})(jQuery);
